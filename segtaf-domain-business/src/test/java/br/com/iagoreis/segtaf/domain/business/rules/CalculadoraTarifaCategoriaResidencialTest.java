...
class CalculadoraTarifaCategoriaResidencialTest {

    private final CalculadoraTarifaCategoria calculadora = new CalculadoraTarifaCategoriaResidencial();

    private final Categoria categoria = Categoria.RESIDENCIAL;
